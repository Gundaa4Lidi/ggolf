...
public class SortUtil {
	 ...
	 * @return
	 */
	public static Collection<Club> sortForDistanceOrPrice(String sortFlag, boolean isSort, String lon, String lat, Collection<Club> clubList){
			...
			if(sortFlag.equals("0")&&lon!=null&&lat!=null){
				...
				for(Club club : clubs){
					if(club.getLongitude()!=null && club.getLatitude()!=null){
						...
						distance = LocationUtil.GetDistance(lon1, lat1, lon2, lat2);//获取距离
