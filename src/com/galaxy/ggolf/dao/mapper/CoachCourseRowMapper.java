...
public class CoachCourseRowMapper implements RowMapper<CoachCourse> {
	...
	public CoachCourse mapRow(ResultSet res) throws SQLException {
		...
		return new CoachCourse(CourseID,CoachID,CoachName,CoachHead,CoachPhone,Title,Price,Verify,Valid,IsOpen,MaxPeople,ContainExplain,IsVideo,Created_TS,Updated_TS);
	}
