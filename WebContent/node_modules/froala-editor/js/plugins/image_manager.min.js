...
!function (a) {
    ...
    if (a.extend(a.FE.DEFAULTS, {
            ...
            function g() {
                B.show(), C.find(".fr-list-column").empty(), b.opts.imageManagerLoadURL ? a.ajax({
                        ...
                        xhrFields: {withCredentials: b.opts.requestWithCredentials},
            ...
            function j(c) {
                var d = new Image, e = a('<div class="fr-image-container fr-empty fr-image-' + H++ + '" data-loading="' + b.language.translate("Loading") + '.." data-deleting="' + b.language.translate("Deleting") + '..">');
                n(!1), d.onload = function () {
                    e.height(Math.floor(e.width() / d.width * d.height));
                    var f = a("<img/>");
                    if (c.thumb) f.attr("src", c.thumb); else {
                        if (r(O, c), !c.url)return r(P, c), !1;
                        f.attr("src", c.url)
                    }
                    if (c.url && f.attr("data-url", c.url), c.tag)if (z.find(".fr-modal-more.fr-not-available").removeClass("fr-not-available"), z.find(".fr-modal-tags").show(), c.tag.indexOf(",") >= 0) {
            ...
            function p(c) {
                var d = a(c.currentTarget).siblings("img"), e = y.data("instance") || b, f = y.data("current-image");
                if (b.modals.hide(J), e.image.showProgressBar(), f) f.data("fr-old-src", f.attr("src")), f.trigger("click"); else {
                    e.events.focus(!0), e.selection.restore();
                    var g = e.position.getBoundingRect(), h = g.left + g.width / 2 + a(b.doc).scrollLeft(), i = g.top + g.height + a(b.doc).scrollTop();
            ...
            function q(c) {
                ...
                confirm(e) && (b.opts.imageManagerDeleteURL ? b.events.trigger("imageManager.beforeDeleteImage", [d]) !== !1 && (d.parent().addClass("fr-image-deleting"), a.ajax({
                        ...
                        data: a.extend(a.extend({src: d.attr("src")}, o(d)), b.opts.imageManagerDeleteParams),
                        crossDomain: b.opts.requestWithCORS,
                        xhrFields: {withCredentials: b.opts.requestWithCredentials},
                        headers: b.opts.requestHeaders
                    }).done(function (a) {
            ...
            function s() {
                var a = z.find(".fr-modal-head-line").outerHeight(), b = D.outerHeight();
                z.toggleClass(".fr-show-tags"), z.hasClass(".fr-show-tags") ? (z.css("height", a + b), D.find("a").css("opacity", 1)) : (z.css("height", a), D.find("a").css("opacity", 0))
            }
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
        ...
        plugin: "imageManager"
    }), a.FE.DefineIcon("imageManager", {NAME: "folder"}), a.FE.DefineIcon("imageManagerInsert", {NAME: "plus"}), a.FE.DefineIcon("imageManagerDelete", {NAME: "trash"})
});